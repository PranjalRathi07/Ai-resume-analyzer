...
const HomeContent = () => {
	return (
		<div className='max-w-6xl mx- text-5xl font-bold mt-5'>
			<motion.div
				...
				<p className='text-base mt-7 text-slate-400'>
					Our free AI-powered resume analyzer provides instant <br /> feedback
					on your resume's strengths and weaknesses, <br /> helping you optimize
					it for success. <br />
			...
			<div className='bg-blend-overlay'>
				<img
					src={dasbordimg}
					alt='poster'
					className='w-2xl h-auto absolute top-[55%] right-0 transform -translate-y-1/2'
				/>
			</div>
		</div>
	);
